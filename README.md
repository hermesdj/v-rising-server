...
- Gérer la version de BepInEx et la version des mods installés
- Finir la gestion des mods
- Finir la gestion des opérations
- Finir la refonte du client web avec la page players, clans, mods et backups
